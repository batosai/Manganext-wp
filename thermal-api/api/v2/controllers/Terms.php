...
class Terms {
	...
	/**
	 *
	 * @return \Voce\Thermal\v2\Models\Terms
	 */
	public static function model() {
		if ( !isset( self::$_model ) ) {
			self::$_model = new \Voce\Thermal\v2\Models\Terms();
		}
		return self::$_model;
	}
	...
	protected static function convert_request( $request_args ) {
		...
		$request_filters = array(
			...
			'orderby' => array( ),
			'order' => array( ),
			'in' => array( '\\Voce\\Thermal\\v2\\toArray', '\\Voce\\Thermal\\v2\\applyInt', '\\Voce\\Thermal\\v2\\toCommaSeparated' ),
			'slug' => array( ),
			'parent' => array( '\\intval' ),
			'hide_empty' => array( '\\Voce\\Thermal\\v2\\toBool' ),
			'pad_counts' => array( '\\Voce\\Thermal\\v2\\toBool' ),
