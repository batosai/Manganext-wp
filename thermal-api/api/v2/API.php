...
class API extends \Voce\Thermal\API_Base {
	...
	public function __construct( \Slim\Slim $app ) {
		...
		// $this->registerRoute( 'POST', 'posts/?', array( __NAMESPACE__ . '\\controllers\\Posts', 'create' ) );
		// $this->registerRoute( 'DELETE', 'posts/?', array( __NAMESPACE__ . '\\controllers\\Posts', 'delete' ) );
		...
		// $this->registerRoute( 'GET', 'users/?', array( __NAMESPACE__ . '\\controllers\\Users', 'signin' ) );
		// $this->registerRoute( 'POST', 'users/?', array( __NAMESPACE__ . '\\controllers\\Users', 'signup' ) );
